        ...
        if not f_EW:
            ...
            if isinstance(delta_temp_n, float):
                flatPlateCollectorData = flat_plate_precalc(
                    ...
                    eta_0, a_1, a_2, temp_collector_inlet, delta_temp_n, 
            ...
            if isinstance(delta_temp_n, float):
                def calculate_flat_plate(azimuth_offset):
                    return flat_plate_precalc(
                        latitude, longitude, collector_tilt, collector_azimuth + azimuth_offset, 
                        eta_0, a_1, a_2, temp_collector_inlet, delta_temp_n, 
                        irradiance_global, irradiance_diffuse, temp_amb_col
                    )
                flatPlateCollectorData1 = calculate_flat_plate(90)
                flatPlateCollectorData2 = calculate_flat_plate(-90)            
