...
if __name__ == '__main__':
    ...
    for cl_hh in [True]:#,'use_dtw',]:#,'use_dtw']:'kshape','kshape',
        for clN in cluster_N:
            ...
            inputfileName="scenario_EcoThierrens_TES_HP_mrgON_CostsOK_real3.xls"
            ...
            for opt in range(1, numberOfOptimizations+1):
                ...
                # save results
                resultFileName = f"results_pareto_mrgON_EcoThierrens_real3_HP_cluster{clN}_hh_{cl_hh}" + str(numberOfBuildings) + '_' + str(opt) + '.xlsx'    # result filename for each optimization
            ...
            figureFileName = f"Pareto_EcoThierrens_real3_HP_PV_PVT_ST_TES_mrgON_Cl{clN}_hh_{cl_hh}.png"
