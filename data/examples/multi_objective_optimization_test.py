...
if __name__ == '__main__':
    ...
    for clN in cluster_N:
        ...
        for opt in range(1, numberOfOptimizations+1):
            ...
            # save results
            resultFileName = f"results_pareto_mrgON_IamLenz_10_GSHP_cluster{clN}" + str(numberOfBuildings) + '_' + str(opt) + '.xlsx'    # result filename for each optimization
        ...
        figureFileName = f"Pareto_IamLenz_10_GSHP_PV_PVT_ST_075TES_mrgON_Cl{clN}.png"
