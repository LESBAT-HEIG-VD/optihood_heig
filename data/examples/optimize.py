...
if __name__ == '__main__':
    ...
    # inputfileName = r"./scenario_Annual_4_costs_100%_SH35_last.xls"
    inputfileName = r"./scenario.xls"

    resultFilePath = r"../results"
    resultFileName = r"results2_yes_mine2.xlsx" if clustering else "results2_no.xlsx"
